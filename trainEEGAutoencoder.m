function [net, info] = trainEEGAutoencoder(X_train, X_test, cfg)
    ...
    % 3) Training options
    % -------------------
    % --- SAFEGUARD: Ensure ValidationFrequency is always at least 1 ---
    val_freq = max(1, floor(size(Xtr,1) / cfg.batchSize));
    ...
    options = trainingOptions("adam", ...
        ...
        "LearnRateDropPeriod", 5, ...             % <-- NEW: Drop the LR every 50 epochs
