...
fig7 = figure('Position',[50 50 1000 300]);
...
% Save main summary figures to parent directory
saveas(fig3, fullfile(results_dir, ['Main_Summary_Trace_AE' file_suffix '.png']));
saveas(fig1, fullfile(results_dir, ['Main_Summary_Metrics_AE' file_suffix '.png']));
